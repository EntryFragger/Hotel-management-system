    ...
    public class EmployeeInforController : ControllerBase
    {
        ...
        public IActionResult GetEmployeeSimpleInfor(string tokenValue,string department,string ID)
        {
            try
            {
                ...
                {
                    EmployeeInforSimple employeeInforSimple = Employee.QueryByID(ID);
        ...
        [ProducesResponseType(200)]
        [ProducesResponseType(400)]
        public IActionResult GetEmployeeDetailedInfor(string tokenValue, string ID)
        {
            try
            {
                EmployeeInforToken user = JWTHelper.GetUsers(tokenValue);
        ...
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        public IActionResult DeleteEmployeeInfor(string tokenValue, string ID)
        {
            try
            {
                EmployeeInforToken user = JWTHelper.GetUsers(tokenValue);
