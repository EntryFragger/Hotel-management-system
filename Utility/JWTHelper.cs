...
namespace BackEnd.DBUtility
{
    ...
    {
        //私钥设置
        private static string saltKey = "dshjdsdkjahsdhsdk";
        ...
        public static EmployeeInforToken GetUsers(string tokenValue)
        {
            JWTPayload jwtPayload = JWTHelper.GetPayloadFromToken(tokenValue);
            EmployeeInforToken user = new EmployeeInforToken();
            user.ID = jwtPayload.ID;
            user.Department = jwtPayload.Department;
            return user;
        }
    }
}
